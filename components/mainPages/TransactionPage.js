...
function TransactionPage() {
    const { getTransactions, selectedTransactions, cancelOrder, setDisplay, removeItem } = useTransaction()
            ...
            <main>
                {
                    selectedTransactions?.map(transaction => (
                        <TransactionItem data={transaction} cancelOrder={cancelOrder} removeItem={removeItem} key={transaction?._id} />
                    ))
                }
            </main>
        </div>
